...
_Noreturn void shell_setup() {
    ...
    printk("\033[91mWelcome to \033[1mCoolPotOS\033[0m!\n");
    sys_info();
    ...
    if (IS_DEVELOP_VERSION) {printk("[ \033[34mNOTE\033[0m ] This shell is in a \033[4mCoolPotOS' develop version\033[0m.\n"); printk("[ \033[34mNOTE\033[0m ] System is auto login with \033[1mKernel\033[0m now.\n");}
    else
    {
        // login now
        printk("Username: ");
